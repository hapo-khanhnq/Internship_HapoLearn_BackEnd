...
<section class="course-details-section">
    <div class="container-fluid py-3 path-to-course-details">
        <span><a @if (Auth::check()) href="{{ route('home') }}" @else href="/" @endif>Home</a>&nbsp; > &nbsp;<a href="{{ route('courses') }}">All Courses</a>&nbsp; > &nbsp;<a href="">Course detail</a></span>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-8">
                    ...
                    <div class="tab-content" id="courseTabContent">
                        <div class="container tab-pane fade show active px-2" id="lessons" role="tabpanel" aria-labelledby="lessons-tab">
                            <div class="row py-4 ml-0">
                                ...
                                <div class="col-12 pl-0 mt-4 d-flex">
                                <div class="w-25">
                                    Learning progress: {{ $course->learning_progress }} %
                                </div>
                                <div class="progress w-75">
                                    <input type="text" hidden id="course-learning-progress-value" value="{{ $course->learning_progress }}%">
                                    <div id="course-learning-progress" class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                </div>
                            </div>
                                ...
                                <div class="col-3 d-flex justify-content-end align-items-center pr-2">
                                    @if($course->check_student_in_course)
                                        @if ($lesson->check_lesson_learned)
                                            <a href="{{ route('lesson.details', $lesson->id) }}" class="btn learned-lesson-button">Learned</a>
                                        @elseif ($lesson->check_lesson_learning)
                                            <a href="{{ route('lesson.details', $lesson->id) }}" class="btn learning-lesson-button">Learning</a>
                                        @else
                                        <form action="{{ route('lesson.take') }}" method="post">
                                            @csrf

                                            <input type="hidden" name="id" value="{{ $lesson->id }}">
                                            <button type="submit" class="learn-lesson-button">Learn</button>
                                        </form>
                                        @endif
                                    @endif
                                </div>
